...
const button1 = addFloatButton('This is a button', () => console.log('The first button was pressed'))
const button2 = addFloatButton('Button with emoji 🙂', () => console.log('The second button was pressed'))
console.log(button1)
console.log(button2)
